...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Manage Bookings', href: '/dashboard' }];

export default function BookingsIndex({ auth, bookings }: BookingProps) {
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <h3 className="mb-4 text-lg font-medium text-gray-900">All Bookings</h3>
